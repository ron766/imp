...
IDG.GPT = {
    unitName: "",
    localIsMoble: false,
    welcomeFreqCap: false,
    isSlideshow: false,
    isSRA: true,
    disableInitialLoad:false,
    otherAds:{},
    googleCommandPush: function(functionToExecute, arg1, arg2, arg3, arg4) {
        googletag.cmd.push(function() {
            functionToExecute(arg1, arg2, arg3, arg4);
        });
    },
    ...
    getLazyAdCode: function(dynamicAd) {
    	var adSlots = "[[300,250]" + ((IDG.GPT.getSize($thm.deviceWidth()) === "desktop")? "]" : ", [300,50]]");
    	var adString = "<code type=\"text\/javascript\">" +
	        ...
	        "consent.ads.queue.push(function(){IDG.GPT.defineGoogleTagSlot(IDG.GPT.getIMUSlotName(), " + adSlots + ", false, " + dynamicAd + ");});" +
	        "document.write('</div>');" +
	        "consent.ads.queue.push(function(){$('#' + IDG.GPT.getIMUSlotName()).responsiveAd({screenSize:'971 1115', scriptTags: []});" +
	        "if (Object.keys(IDG.GPT.companions).length > 0 || IDG.GPT.disableInitialLoad) { IDG.GPT.refreshAd(IDG.GPT.getIMUSlotName());}});//--></code>";
    	return adString;
    },
    getLazyAdCodeRefreshed: function(dynamicAd) {
    	var adString2 = "<code type=\"text\/javascript\">" +
	        ...
	        "document.write('<div id=\"' +IDG.GPT.getIMUSlotName() + '\" class=\"ad-container\">');" +
	        "consent.ads.queue.push(function(){IDG.GPT.defineGoogleTagSlot(IDG.GPT.getIMUSlotName(), [[300,250]], true, " + dynamicAd + ");});" +
	        "document.write('</div>');" +
	        "consent.ads.queue.push(function(){$('#' + IDG.GPT.getIMUSlotName()).responsiveAd({screenSize:'971 1115', scriptTags: []});});" +
	        "//--></code>";
	    return adString2;
    ...
    defineGoogleTagSlot: function(slotName, slotAdSize, adSlotRefreshes, dynamicAd) {
        if (IDG.GPT.unitName != null && IDG.GPT.unitName != "" && slotName != "") {
            IDG.GPT.addDisplayedAd(slotName, "true");
            IDG.GPT.googleCommandPush(IDG.GPT._defineGoogleTagSlot, slotName, slotAdSize, adSlotRefreshes, dynamicAd);
        }
    },
    _defineGoogleTagSlot: function(slotName, slotAdSize, adSlotRefreshes, dynamicAd) {
    	try {
            if (IDG.GPT.adIsContained(slotName) || !IDG.GPT.isSRA || dynamicAd) {
            ...
            //performance.mark('defineSlot_'+slotName); 
        	//console.log('%cslot defined - ' + slotName +  ': ' + + performance.getEntriesByName('defineSlot_'+slotName)[0].startTime,"color:blue; font-size:large");
        }
        catch (e){
    ...
    _displayGoogleTagSlot: function(slotName) {
        ...
        //performance.mark('displaySlot_'+ slotName); 
    	//console.log('%cdisplay slot - ' + slotName + ': ' + + performance.getEntriesByName('displaySlot_'+ slotName)[0].startTime,"color:blue; font-size:large");
    },
    ...
    _renderPos: function(slotName){
        ...
        else if (slotName.indexOf('imu') > -1) {
        	var btfPos = 'BTF' + (slotName.replace(/imu/g,"") - 1);
        	return btfPos;
        }
    ...
    _defineAllGoogleTagSlots: function(slotArray) {
        try {
            ...
            // }
            //performance.mark('defineAllSlots'); 
        	//console.log('%cAll slots defined: ' + performance.getEntriesByName('defineAllSlots')[0].startTime,"color:blue; font-size:large");
        }
        catch (e) {
            console.log("IDG.GPT Not Available: "+e);
        }
    ...
    _setAllGoogleTagTargetings: function() {
        ...
        //performance.mark('setAllGoogleTagTargetings');
        //console.log('%call google ad targetings set: ' + performance.getEntriesByName('setAllGoogleTagTargetings')[0].startTime,"color:blue; font-size:large");
    },
    initGoogleTagService: function() {
        IDG.GPT.googleCommandPush(IDG.GPT._initGoogleTagService);
    },
    _initGoogleTagService: function() {
    	//check to see if personalization is allowed
    	try {
	    	if (!consent.personalization) {
	    		googletag.pubads().setRequestNonPersonalizedAds(1);
	    			console.log('*****GDPR: need to load in non-personalized ad mode');
	       	}
	   		else {
	   			console.log('*****GDPR: load in normal ad mode');
	   		}
	    }
    	catch (e) {
    		console.log(e);
        ...
        //performance.mark('initGTag'); 
    	//console.log('%cgoogletag services enabled: ' + + performance.getEntriesByName('initGTag')[0].startTime,"color:blue; font-size:large");
    ...
    _responsiveAdDisplay: function(id) {
        ...
        //performance.mark('responsiveDisplay_'+ id); 
    	//console.log('%cresponsiveDisplay - ' + id + ': ' + performance.getEntriesByName('responsiveDisplay_'+ id)[0].startTime,"color:blue; font-size:large");
    },
    ...
    setIDGExtraTargetings: function() {
        try {
            ...
            if(tmp_squery!=null && tmp_squery.indexOf('@') == -1 && tmp_squery.indexOf('%40') == -1
            ...
            //performance.mark('extraIDGE'); 
        	//console.log('%csetIDGEExtraTargetings: ' + + performance.getEntriesByName('extraIDGE')[0].startTime,"color:blue; font-size:large");
        } catch(e) {
            //console.log(e);
        }
    },
    ...
    getPlace:function(){
        ...
        else if (url.toString().indexOf("/podcast/")!= -1) return "podcast"
